...
//        $data->form = DB::table('bitform')->select( '*')->where('bitform_bittable_parent_id',$id)->get();
    ...
    public function bitGet(Request $request, $table, $index = 0)
    {
        $data = new stdClass();
        $data->form = [
            'parent' =>
            ...
            'child' =>
                [
                    ...
                    ['label' => "Field Default", 'id' => "field[$index][bittable_default]", 'input' => "input", 'type' => "text", 'url' => ""],
                    ['label' => "Field Nullable", 'id' => "field[$index][bittable_nullable]", 'input' => "input", 'type' => "text", 'url' => ""],
                    ['label' => "Join Table Type", 'id' => "field[$index][bittable_join]", 'input' => "select", 'type' => "select", 'url' => route('bit.select', 'bittable_join')],
                    ['label' => "Join To ID", 'id' => "field[$index][bittable_to_id]", 'input' => "select", 'type' => "select", 'url' => route('bit.select', 'bittable_to_id')],
                ],
